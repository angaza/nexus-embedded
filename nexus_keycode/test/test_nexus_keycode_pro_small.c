...
static void _small_fixture_reinit(const char start_char, const char* alphabet)
{
    ...
    nexus_keycode_core_internal_init(&small_config);
    ...
    port_identity_get_secret_key_IgnoreAndReturn(
        NEXUS_INTEGRITY_CHECK_FIXED_00_KEY);
    port_identity_get_serial_id_IgnoreAndReturn(FAKE_DEVICE_ID);
}
    ...
    void)
{
    TEST_ASSERT_EQUAL_UINT(
        NEXUS_KEYCODE_IDLE_TIME_BETWEEN_PROCESS_CALLS_SECONDS,
    ...
    void)
{
    struct test_scenario
    {
        ...
        enum port_feedback_type fb_type;
    };
    ...
    const struct test_scenario scenarios[] = {
        {true, "1234567", PORT_FEEDBACK_TYPE_MESSAGE_INVALID},
        {true, "30211130301021", PORT_FEEDBACK_TYPE_MESSAGE_APPLIED}, // 12
        {false, "30211130301021", PORT_FEEDBACK_TYPE_MESSAGE_VALID}, // 12
        {false, "10210203303303", PORT_FEEDBACK_TYPE_MESSAGE_APPLIED}, // 13
        {false, "30123220313102", PORT_FEEDBACK_TYPE_MESSAGE_APPLIED}, // 14
        {false, "10210203303303", PORT_FEEDBACK_TYPE_MESSAGE_VALID}, // 13
        {false,
         "33020121210023",
         PORT_FEEDBACK_TYPE_MESSAGE_APPLIED}, // WIPE_IDS_ALL
        {false, "30123220313102", PORT_FEEDBACK_TYPE_MESSAGE_APPLIED}, // 14
    };
    ...
    for (uint8_t i = 0; i < sizeof(scenarios) / sizeof(scenarios[0]); ++i)
    {
        ...
        port_payg_state_get_current_IgnoreAndReturn(PAYG_STATE_ENABLED);
        port_payg_credit_add_IgnoreAndReturn(true);

        port_feedback_start_ExpectAndReturn(scenario.fb_type, true);
        nexus_keycode_pro_process();
    }
}
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    // Add 6 days
    port_payg_credit_add_ExpectAndReturn(6 * 24 * 3600, true);
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(231 * 24 * 3600, true);
    enum nexus_keycode_pro_response response =
        nexus_keycode_pro_small_apply(&message);
...
void test_nexus_keycode_pro_small_apply__valid_unlock__unit_is_unlocked(void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_unlock_ExpectAndReturn(true);
    enum nexus_keycode_pro_response response =
        nexus_keycode_pro_small_apply(&message);
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_UNLOCKED);
...
void test_nexus_keycode_pro_small_apply__set_credit_valid__credit_applied(void)
{
    ...
    for (uint8_t i = 0; i < sizeof(scenarios) / sizeof(scenarios[0]); ++i)
    {
        ...
        port_payg_credit_set_ExpectAndReturn(
...
void test_nexus_keycode_pro_apply__update_pd__window_and_pd_ok(void)
{
    ...
    struct nx_check_key secret_key = port_identity_get_secret_key();
    enum nexus_keycode_pro_response response;
    ...
    for (uint8_t i = 0; i < sizeof(scenarios) / sizeof(scenarios[0]); ++i)
    {
        ...
        port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_ENABLED);
        port_payg_credit_add_ExpectAndReturn(2 * 24 * 3600, true);
...
void test_nexus_keycode_pro_small_apply__set_credit_valid__unlock_lock(void)
{
    ...
    port_payg_credit_set_ExpectAndReturn(0, true);
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(15 * 24 * 3600, true);
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(1 * 24 * 3600, true);
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(3600 * 24 * 2, true);
    enum nexus_keycode_pro_response response =
...
void test_nexus_keycode_pro_small_apply__test_message__short_test(void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(
    ...
    void)
{
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_ENABLED);
    port_payg_credit_add_ExpectAndReturn(24 * 60 * 60, true);
