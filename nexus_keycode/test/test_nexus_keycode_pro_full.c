...
static void _full_fixture_reinit(const char start_char,
                                 const char end_char,
                                 const char* alphabet,
                                 const struct nx_check_key device_key)
{
    ...
    void)
{
    ...
    const struct nx_check_key key_mixed = {{0x12,
                                            0xff,
                                            0x00,
                                            0xff,
                                            0xff,
    ...
    for (uint8_t i = 0; i < sizeof(scenarios) / sizeof(scenarios[0]); ++i)
    {
        ...
        port_identity_get_secret_key_IgnoreAndReturn(key_mixed);
    ...
    void)
{
    ...
    struct test_scenario
    {
        ...
        enum payg_state payg_state_before;
    };
    ...
    const struct test_scenario scenarios[] = {
        ...
        {"63530515961148",
         NEXUS_KEYCODE_PRO_RESPONSE_VALID_APPLIED,
         false,
         PAYG_STATE_ENABLED}, // payg state not examined
    ...
    port_payg_credit_set_IgnoreAndReturn(true);
    ...
    for (uint8_t i = 0; i < sizeof(scenarios) / sizeof(scenarios[0]); ++i)
    {
        ...
        {
            port_payg_state_get_current_ExpectAndReturn(
    ...
    void)
{
    ...
    struct nx_check_key test_key = port_identity_get_secret_key();
    TEST_ASSERT_EQUAL_UINT8_ARRAY(
        &test_key.bytes, &key_mixed.bytes, sizeof(struct nx_check_key));
    ...
    void)
{
    ...
    port_identity_get_serial_id_IgnoreAndReturn(0xBC614E);
    ...
    port_identity_get_serial_id_IgnoreAndReturn(0x075bcd15);
    ...
    port_identity_get_serial_id_IgnoreAndReturn(0x499602d2);
    ...
    void)
{
    ...
    port_identity_get_serial_id_ExpectAndReturn(hwid);
    enum nexus_keycode_pro_response response =
        nexus_keycode_pro_full_apply_factory(&confirm_payg_id_message);
    ...
    void)
{
    ...
    port_passthrough_keycode_IgnoreAndReturn(PORT_PASSTHROUGH_ERROR_NONE);
    bool parsed = nexus_keycode_pro_full_parse(&frame, &message);
    TEST_ASSERT(parsed);
    ...
    void)
{
    ...
    */
    ...
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_DISABLED);
    port_payg_credit_add_ExpectAndReturn(60 * 10, true);
    ...
    // Demo for 30 minutes
    port_payg_state_get_current_ExpectAndReturn(PAYG_STATE_ENABLED);
    port_payg_credit_add_ExpectAndReturn(60 * 30, true);
    ...
    void)
{
    ...
    const struct nx_check_key key_all1s = {{0xff,
                                            0xff,
                                            0xff,
                                            0xff,
                                            0xff,
